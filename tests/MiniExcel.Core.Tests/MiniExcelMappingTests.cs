...
public class MiniExcelMappingTests
{
    ...
    [Fact]
    public void Sequential_Mapping_Should_Optimize_Performance()
    {
    ...
    [Fact]
    public void NonSequential_Mapping_Should_Use_Universal_Optimization()
    {
